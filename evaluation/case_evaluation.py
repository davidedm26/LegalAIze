    ...
    *,
    ...
    for pred in predictions:
        ...
        for sub in sub_reqs:
            ...
            ragas_question = f"Based on the provided text, what is the detailed rationale and summary regarding the document's compliance with the '{req_name}' sub-requirement '{sub_name}' from {source}?"
